...
export default function PeonList() {
  ...
  const staffCollectinRef = collection(db, "peon");
  ...
  const deleteUser = async (id) => {
    try {
      const UserDoc = doc(db, "peon", id);
      await deleteDoc(UserDoc);
    } catch (e) {
      console.error("Error adding document: ", e);
    }
    ToastAndroid.show("successfully Deleted!", ToastAndroid.SHORT);
    navigation.navigate("Registered Peon Members");
    forceUpdate();
    // location.reload();
  };
  ...
  const updatemember = async (id) => {
    try {
      const docRef = await getDoc(doc(db, "peon", id));
  ...
  const setupdate = async () => {
    await updateDoc(doc(db, "peon", updateuser.uid), {
      email: updateuser.email,
      peon_deparment: updateuser.peon_deparment,
      peon_phone: updateuser.peon_phone,
      peon_service_id: updateuser.peon_service_id,
      peon_name: updateuser.peon_name,
    });
      ...
      <Modal visible={modalOpen} transparent={true} animationType="fade">
        ...
        >
          ...
          >
            ...
            <TextInput
              placeholder="peon_deparment"
              value={updateuser.peon_deparment}
            ...
            <TextInput
              placeholder="peon_name"
              value={updateuser.peon_name}
            ...
            <TextInput
              placeholder="peon_service_id"
              value={updateuser.peon_service_id}
            ...
            <TextInput
              ...
              placeholder="peon_phone"
              value={updateuser.peon_phone}
